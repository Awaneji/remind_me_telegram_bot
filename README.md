...
We have introduced Quartz scheduler for handling and scheduling user entered queries and running jobs against user queries.
To aid in that process, you will need to run the following SQL query in your mysql database (see `application.properties` file in the classpath):
